...
export default function ServiceManagement() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      {notification.show && (
        <div className={`p-4 mb-6 rounded-md flex items-center ${notification.type === 'success' ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'
          }`}>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
        <h2 className="text-lg font-medium text-gray-800 mb-4">Add New Service</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6 flex justify-end">
            <button
              type="submit"
              disabled={isLoading}
              className={`flex items-center px-4 py-2 rounded-md text-white ${isLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-gray-800 hover:bg-gray-700'
                } transition-colors`}
            >
              {isLoading ? (
                <>
